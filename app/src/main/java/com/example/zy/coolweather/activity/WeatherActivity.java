package com.example.zy.coolweather.activity;
...
import com.example.zy.coolweather.R;
import com.example.zy.coolweather.gson.Forecast;
import com.example.zy.coolweather.gson.Weather;
import com.example.zy.coolweather.service.AutonUpdateService;
...
public class WeatherActivity extends AppCompatActivity {
    ...
    private void showWeatherInfo(Weather weather) {
        if (weather != null) {
            ...
            Intent intent = new Intent(this, AutonUpdateService.class);
            startService(intent);
        } else {
